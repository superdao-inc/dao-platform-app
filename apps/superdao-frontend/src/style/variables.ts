export const colors = {
	...
	overlaySecondaryHover: 'rgba(208, 220, 245, 0.2)',
	overlaySecondaryActive: 'rgba(208, 220, 245, 0.4)',
	...
	twitter: '#21A6FA',
	twitterHover: '#21A6FA',
	twitterActive: '#21A6FA',
	polygonScan: '#601DCF',
	polygonScanHover: '#601DCF',
	polygonScanActive: '#601DCF'
};
...
export const translations = {
	horisontal: (x: number) => `translateX(${x}px)`
};
