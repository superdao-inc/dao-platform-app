...
export const DetailsLayout: FC<Props> = ({ children, artworks, artworksTotalLength, onMoreArtworks }) => {
	...
	return (
		<div className="sm:bg-backgroundSecondary relative mb-10 mt-0 min-h-[360px] w-full items-start justify-between overflow-hidden rounded-none bg-transparent sm:mb-5 sm:mt-4 sm:grid sm:min-h-[500px] sm:grid-cols-[1fr_260px] sm:rounded-lg">
