var Module = (() => {
	...
	return function (Module) {
		...
		if (!Object.getOwnPropertyDescriptor(Module['ready'], '_decode')) {
			Object.defineProperty(Module['ready'], '_decode', {
				configurable: true,
				get: function () {
					abort(
						'You are getting _decode on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
					);
				}
			});
			Object.defineProperty(Module['ready'], '_decode', {
				...
				set: function () {
					abort(
						'You are setting _decode on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
					);
				}
			});
		}
		...
		if (!Object.getOwnPropertyDescriptor(Module['ready'], '_new_convert')) {
			Object.defineProperty(Module['ready'], '_new_convert', {
				configurable: true,
				get: function () {
					abort(
						'You are getting _new_convert on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
					);
				}
			});
			Object.defineProperty(Module['ready'], '_new_convert', {
				...
				set: function () {
					abort(
						'You are setting _new_convert on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
					);
				}
			});
		}
		if (!Object.getOwnPropertyDescriptor(Module['ready'], '_rust_eh_personality')) {
			Object.defineProperty(Module['ready'], '_rust_eh_personality', {
				configurable: true,
				get: function () {
					abort(
						'You are getting _rust_eh_personality on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
					);
				}
			});
			Object.defineProperty(Module['ready'], '_rust_eh_personality', {
				...
				set: function () {
					abort(
						'You are setting _rust_eh_personality on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
					);
				}
			});
		}
		...
		var wasmBinaryFile;
		wasmBinaryFile = '/wasm/mozjpeg-wasm.wasm';
		...
		var _new_convert = (Module['_new_convert'] = createExportWrapper('new_convert'));
