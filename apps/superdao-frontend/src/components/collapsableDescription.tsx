...
type CollapsableDescriptionProps = {
	transformedDescription?: (string | ReactNode)[];
	description: string;
	className?: string;
};
...
export const CollapsableDescription = memo((props: CollapsableDescriptionProps) => {
	const { description, transformedDescription, className = '' } = props;
	...
	return (
		<div className={classNames('relative mt-4', { 'pb-6': isDescriptionExpanded }, className)}>
			{' '}
