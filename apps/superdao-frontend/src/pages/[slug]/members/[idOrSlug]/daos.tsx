...
const DaoMemberDaosPage: NextPageWithLayout<Props> = (props) => {
	return <UserUI.UserDaos isDaoTab {...props} />;
};

DaoMemberDaosPage.getLayout = getDaoLayout;

export default DaoMemberDaosPage;
