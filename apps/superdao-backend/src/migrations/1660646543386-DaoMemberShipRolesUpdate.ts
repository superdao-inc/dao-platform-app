...
export class DaoMemberRolesUpdate1660646543386 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`UPDATE "dao_membership" SET "role" = 'SUDO' WHERE "userId" = (SELECT "id" FROM "users" WHERE "walletAddress" = '0x736337020906e52ef43542e183eb6f385423d8fe')` //Подставить сюда гнозис кошелек
		);
