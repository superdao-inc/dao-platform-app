...
export interface ERC721WhitelistClaimInterface extends utils.Interface {
  functions: {
    "CLAIM_LIMIT_ERROR()": FunctionFragment;
    "CONTROLLER()": FunctionFragment;
    "__semver()": FunctionFragment;
    "claim(address,bytes32[],bytes32)": FunctionFragment;
    "claimLimitByTier(bytes32)": FunctionFragment;
    "claims(address,bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "CLAIM_LIMIT_ERROR",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "claimLimitByTier",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface ERC721WhitelistClaim extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721WhitelistClaimInterface;
  ...
  functions: {
    CLAIM_LIMIT_ERROR(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    CLAIM_LIMIT_ERROR(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    CLAIM_LIMIT_ERROR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
