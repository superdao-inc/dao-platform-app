...
export interface ERC721WhitelistSaleInterface extends utils.Interface {
  functions: {
    "__semver()": FunctionFragment;
    "buy(bytes32[],bytes32)": FunctionFragment;
    "buyWithLimits(bytes32[],bytes32,uint256,uint256)": FunctionFragment;
    ...
    "merkleProofIpfsHash()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "buyWithLimits",
  ...
  encodeFunctionData(
    functionFragment: "merkleProofIpfsHash",
    values?: undefined
  ): string;
...
export interface ERC721WhitelistSale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721WhitelistSaleInterface;
  ...
  functions: {
    ...
    merkleProofIpfsHash(overrides?: CallOverrides): Promise<[string]>;
    ...
    setMerkleTree(
      ...
      merkleProofIpfsHash_: BytesLike,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    merkleProofIpfsHash(overrides?: CallOverrides): Promise<BigNumber>;
